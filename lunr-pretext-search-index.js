...
},
{
  ...
  "number": "1.16",
  "title": "",
  "body": "  How many two-letter words are there using only the letters , , , ?    We can easily list these, but using the arrangement in Table illustrates a more powerful technique. The table makes it clear that there are 16 two-letter words using the letters , , , and . Another way to see this is to note that there are 4 choices for the first (left-hand) letter and for each of these there are 4 choices for the right-hand letter, so there are words total.   All possible two-letter words using the letters , , ,                                                                          "
},
{
  "id": "root-1-2-4-31",
  "level": "2",
  ...
  "number": "1.17",
  "title": "",
  "body": "  How many numbered words are there consisting of two letters from , , , and followed by one of the digits , , , , and ?    A geometric display as in Table would seem to require three dimensions, but we can take what we already know and just add a digit to the right. See Table . There are 16 rows (each with a word from Example ) and five columns, so there are two-letter words using , , , and , followed by a digit from 1, 2, 3, 4, and 5.   All possible numbered words consisting of two letters from , , , followed by one of the digits , , , , and .                                                                                   "
},
{
  "id": "root-1-2-4-32",
  "level": "2",
...
},
{
  ...
  "number": "2.1",
  "title": "",
  "body": " Function diagram for a function from to .   Function diagram from a four-element set to a four-element set.  Function diagram for a function from to , where maps to , and map to , and maps to .    "
},
{
  "id": "root-1-2-5-9",
  "level": "2",
...
},
{
  ...
  "number": "3.1",
  "title": "",
  "body": " A non-attacking rook arrangement on a chessboard. Four rooks are placed such that no two occupy the same row or column.   Four non-attacking rooks on a six by four chessboard.  A non-attacking rook arrangement on a chessboard. Four rooks are placed such that no two occupy the same row or column.     centers=((.5,2.5),(1.5,5.5),(2.5,.5),(3.5,4.5))          "
},
{
  "id": "root-1-2-6-7",
  "level": "2",
...
},
{
  ...
  "number": "3.2",
  "title": "",
  "body": " Example of a circular permutation for .   Circular permutation of the numbers one through eight.  Example of a circular permutation for . Reading the numbers clockwise, we encounter 1, 4, 5, 2, 8, 7, 3, 6.    alignments=['e','ne','n','nw','w','sw','s','se']  labels=['3','6','1','4','5','2','8','7']  f(t)=(cos(pi*t\/4),sin(pi*t\/4))      ${labels[k]}        "
},
{
  "id": "root-1-2-6-21",
  "level": "2",
...
},
{
  ...
  "body": " Pascal's Triangle of binomial coefficients                   6                                                             "
},
{
  "id": "root-1-2-7-11",
  "level": "2",
...
},
{
  ...
  "number": "5.6",
  "title": "",
  "body": "  Determine what each of the following sums is equal to.       "
},
{
  "id": "root-1-2-8-14",
  "level": "2",
...
},
{
  ...
  "number": "8.1",
  "title": "",
  "body": " One possible covering for the case involving for Problem .   A four by four grid with five L-shapes covering all but one square.  A grid with five L-shapes covering all but one square.    "
},
{
  "id": "thm_PMI2",
  "level": "2",
...
},
{
  ...
  "number": "10.1",
  "title": "",
  "body": "  Here is an example of a graph with vertex set .   Graph with five vertices, seven regular edges, and one loop.  Graph with vertices and edges , , , , , , , and a loop at .     "
},
{
  "id": "root-1-2-13-6",
  "level": "2",
...
},
{
  ...
  "number": "10.26",
  "title": "",
  "body": "  Consider the bipartite graph given below. Is there a total matching from to ? If so, find one. If not, explain why.   Bipartite graph with four top vertices and five bottom vertices.  Bipartite graph with top vertices , bottom vertices , and edges , , , , , , , , and .     "
},
{
  "id": "root-1-2-13-47",
  "level": "2",
  ...
  "number": "10.27",
  "title": "",
  "body": "  Consider the bipartite graph given below. Is there a total matching from to ? If so, find one. If not, explain why.   Bipartite graph with four top vertices and four bottom vertices.  Bipartite graph with top vertices , bottom vertices , and edges , , , , , , , , and .     "
},
{
  "id": "root-1-2-13-48",
  "level": "2",
...
},
{
  ...
  "number": "11.1",
  "title": "",
  "body": "  Find the indegree and outdegree of each vertex in the following graph.   Digraph with ten vertices and fifteen directed edges.  Digraph with vertices and directed edges , , , , , , , , , , , , , , and .     "
},
{
  "id": "root-1-2-14-5",
  "level": "2",
...
},
{
  ...
  "number": "11.5",
  "title": "",
  "body": "  Find the adjacency matrix for the following graph.   Graph with five vertices and seven edges.  Graph with vertices and edges , , , , , , and .     "
},
{
  "id": "root-1-2-14-13",
  "level": "2",
...
},
{
  "id": "root-1-2-14-20",
  "level": "2",
  "url": "root-1-2-14.html#root-1-2-14-20",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "invariant "
},
{
  ...
  "number": "11.10",
  "title": "",
  "body": "  Determine whether the following graphs are isomorphic.     Graph G with six vertices and seven edges.  Graph with vertices and edges , , , , , , and .        Graph H with six vertices and seven edges.  Graph with vertices and edges , , , , , , and .        "
},
{
  "id": "root-1-2-14-22",
  "level": "2",
  ...
  "number": "11.11",
  "title": "",
  "body": "  Let be the graph with vertex set and edge set and let be the following graph.   Graph H with five vertices and six edges.  Graph with vertices and edges , , , , , and .    Determine whether and are isomorphic.   "
},
{
  "id": "root-1-2-14-23",
  "level": "2",
  ...
  "number": "11.12",
  "title": "",
  "body": "  Determine which pairs of the following graphs are isomorphic.     Graph G with six vertices and seven edges.  Graph with vertices and edges , , , , , , and .        Graph H with six vertices and seven edges.  Graph with vertices and edges , , , , , , and .        Graph K with six vertices and seven edges.  Graph with vertices and edges , , , , , , and .        "
},
{
  "id": "root-1-2-14-24",
  "level": "2",
  ...
  "number": "11.13",
  "title": "",
  "body": "  Determine whether the following digraphs are isomorphic.     Digraph G with eight vertices and twelve directed edges.  Digraph with vertices and directed edges , , , , , , , , , , , and .        Digraph H with eight vertices and twelve directed edges.  Digraph with vertices and directed edges , , , , , , , , , , , and .        "
},
{
  "id": "root-1-2-14-25",
  "level": "2",
...
},
{
  "id": "root-1-2-14-27",
  "level": "2",
  "url": "root-1-2-14.html#root-1-2-14-27",
  "type": "Theorem",
  "number": "11.14",
  "title": "",
...
},
{
  ...
  "number": "11.18",
  "title": "",
  "body": "  Eulerize the following graph.   A four by three grid graph, with four columns and three rows.  A grid graph, with four columns and three rows.     "
},
{
  "id": "root-1-2-14-35",
  "level": "2",
...
},
{
  ...
  "number": "11.19",
  "title": "",
  "body": "  Determine whether each of the following graphs has a Hamilton circuit or a Hamilton path that is not a circuit.     Graph G, a four by three grid graph.  Graph , a grid graph with four columns and three rows.        Graph H, a five by five grid graph.  Graph , a grid graph with five columns and five rows.        "
},
{
  "id": "root-1-2-14-38",
  "level": "2",
  "url": "root-1-2-14.html#root-1-2-14-38",
  "type": "Theorem",
  "number": "11.20",
...
},
{
  ...
  "number": "11.26",
  "title": "",
  "body": "  Find a spanning tree for each of the following.     Graph G, a four by three grid graph.  Graph , a grid graph with four columns and three rows.        Graph H, a five by five grid graph.  Graph , a grid graph with five columns and five rows.        "
},
{
  "id": "root-1-2-14-47",
  "level": "2",
...
},
{
  "id": "root-1-2-14-49",
  "level": "2",
  "url": "root-1-2-14.html#root-1-2-14-49",
  "type": "Theorem",
  "number": "11.28",
  "title": "",
...
},
{
  "id": "root-1-2-14-51",
  "level": "2",
  "url": "root-1-2-14.html#root-1-2-14-51",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "root-1-2-14-53",
  "level": "2",
  "url": "root-1-2-14.html#root-1-2-14-53",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "root-1-2-14-55",
  "level": "2",
  "url": "root-1-2-14.html#root-1-2-14-55",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",

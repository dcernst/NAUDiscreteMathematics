...
},
{
  ...
  "number": "1.16",
  "title": "",
  "body": "  How many two-letter words are there using only the letters , , , ?    We can easily list these, but using the arrangement in Table will illustrate a more powerful technique.   All possible two-letter words using the letters , , ,                                                                         The rectangular table makes it clear that there are 16 two-letter words using the letters , , , and . Another way to see this is to note that there are 4 choices for the first (left-hand) letter and for each of these there are 4 choices for the right-hand letter, so there are words total.   "
},
{
  "id": "root-1-2-4-31",
  "level": "2",
